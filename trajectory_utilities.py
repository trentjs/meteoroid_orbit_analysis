...
def altaz2radec(altaz, obs_llh, C_ENU2ECI): #[n,2],[3,n],[n,3,3],[n]
...
def altaz2radec_jac(altaz, obs_llh, C_ENU2ECI):
    ''' Jacobian of the track errors using central differencing '''
    ...
    for i, s in enumerate(step):
        radec_pos = altaz2radec(altaz+s, obs_llh, C_ENU2ECI) #[n,2]
        radec_neg = altaz2radec(altaz-s, obs_llh, C_ENU2ECI) #[n,2]
